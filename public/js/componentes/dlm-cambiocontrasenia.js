                    ...
                    xhr.onreadystatechange = function () {
                        if (this.readyState == 4 && this.status == 200) {
                            ...
                            if (update == 1) {   
                                ...
                                node.setAttribute("class", "font-bold text-blue-600");
    ...
    verPassword(){
        ...
        repiteToggle.addEventListener('change', function() {
            ...
            if (repite.type === 'password') {
                repite.type = 'text'
                repiteLabel.innerHTML = "<i class='far fa-eye-slash texto-violeta-oscuro text-base xl:text-xl js-repite-label'></i>";
            } else {
                repite.type = 'password'
                repiteLabel.innerHTML = "<i class='far fa-eye texto-violeta-oscuro text-base xl:text-xl js-repite-label'></i>";
            }
                                        ...
                                        <div class="flex flex-col space-y-1">
                                            ...
                                            <div class="relative w-full">
                                                ...
                                                <input 
                                                        ...
                                                        name="pass"
                                                        autofocus
                                                        class="appearance-none w-full js-password inputLogin px-4 py-2 transition duration-300 border border-gray-300 rounded focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-700" autocomplete="off" />
                                            ...
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="relative w-full">
                                                    ...
                                                    <div class="absolute inset-y-0 right-0 flex items-center px-2">
                                                        ...
                                                        <label class="bg-gray-300 hover:bg-gray-400 rounded px-2 py-1 text-sm text-gray-600 font-mono cursor-pointer js-repite-label" for="togglerepite"><i class='far fa-eye texto-violeta-oscuro text-base xl:text-xl'></i></label>
                                                    ...
                                                    <input 
                                                            ...
                                                            id="repite"
                                                            name="repite"   
                                                            class="appearance-none w-full js-repite inputLogin px-4 py-2 transition duration-300 border border-gray-300 rounded focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-700" autocomplete="off" />
                                                
                                                </div>                                                    
                                        </div>
                                    
                                        <span id="mensajeValidacion" class="font-bold font-bold text-blue-600"></span> 
                                        <div id="contenedorBoton">                     
                                            <button id="cambiarPassword" class="w-full px-4 py-2 text-lg font-semibold text-white transition-colors duration-300 bg-violeta-oscuro hover:bg-blue-900 rounded-md shadow focus:outline-none focus:ring-blue-200 focus:ring-4">${this.nombre}</button>                     
                                        </div>                    
                                    </form>`;
        }
            parte1 += `
