                ...
                xhr.onreadystatechange = function () {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        if (valida == 1) {
                            ...
                            node.setAttribute("class", "font-bold font-bold text-blue-600");
                            ...
                            <div class="flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md">
                                ...
                                <div class="p-5 bg-white md:flex-1" id="contenedorReestablecer">
                                    ...
                                    <form class="flex flex-col space-y-5">            
                                        ...
                                        <div>
                                            <button id="recuperarPassword" class="w-full px-4 py-2 text-lg font-semibold text-white transition-colors duration-300 bg-violeta-oscuro hover:bg-blue-700 rounded-md shadow focus:outline-none focus:ring-sky-600 focus:ring-4">${this.nombre}</button>               
                                        </div>
