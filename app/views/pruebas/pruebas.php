...
<div class="w-full overflow-x-hidden border-t flex flex-col">
    ...
    <main class="w-full flex-grow p-6">
       ...
       <dlm-hoy nombre="Jenny" apellido="ruiz" pedidos="1" numeroPedido="76543"></dlm-hoy>

       <br><br>
       <dlm-hoy nombre="miguel" apellido="bonilla"></dlm-hoy>
    ...
    <br><br>
        <dlm-tabla url="datos.json" titulos="Nombre,Apellidos"></dlm-tabla>
