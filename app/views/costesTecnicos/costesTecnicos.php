...
<div class="w-full overflow-x-hidden border-t flex flex-col">
    ...
    <div class="container mx-auto px-1 xl:px-2">
            ...
            <div class="py-4">
                    ...
                    <div class="flex">
                        <h2 class="text-xl font-semibold leading-tight flex-initial mr-2">Costes horas técnicos</h2>
                        <a href="" id="nuevoCosteTecnico" class="rounded-full h-10 w-10 flex items-center justify-center bg-violeta-oscuro text-white flex-initial"><i class="fas fa-user-plus"></i></a>
                    </div>                                                     
                    ...
                    <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                        <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                            <div id="destinocostestecnicosajax"></div>
                        </div>
                    </div>        
...
<script  type="module">
  ...
  arrancar("tablacostestecnicos","CostesTecnicos/crearTablaCostesTecnicos", "destinocostestecnicosajax", "pktabla", "DESC", 0, "buscador","CostesTecnicos/totalRegistrosCostesTecnicos", [10, 20, 30],"min-w-full leading-normal","paginador",["editar","eliminar"],"","");

</script>

<?php require_once(RUTA_APP . '/views/costesTecnicos/eliminarCoste.php'); ?>
<?php require_once(RUTA_APP . '/views/costesTecnicos/crearCosteTecnico.php'); ?>
<?php require_once(RUTA_APP . '/views/costesTecnicos/editarCosteTecnico.php'); ?>
