...
<style>
	...
	<div>
		<button onclick="openModal('main-modal')" class='bg-pink-500 text-white p-2 rounded text-2xl font-bold'>Open Modal</button>
	</div>
    <div>
		<button onclick="openModal('another-modal')" class='mt-5 bg-pink-500 text-white p-2 rounded text-2xl font-bold'>Open Another Modal</button>
	</div>
