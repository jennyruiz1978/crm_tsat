        ...
        <main class="w-full flex-grow p-6">
            ...
            <div class="container mx-auto px-1 xl:px-2">
                ...
                <div class="py-4">
                        ...
                        <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                            <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                                <div id="destinousuariosajax"></div>
                            </div>
                        </div>        
                ...
                <script  type="module">
                    ...
                    arrancar("tablausuarios","Usuarios/crearTablaUsuarios", "destinousuariosajax", "idusuario", "DESC", 0, "buscador","Usuarios/totalRegistrosUsuarios", [10, 20, 30],"min-w-full leading-normal","paginador",["verUsuario","eliminar"],"<?php echo RUTA_URL.'/Usuarios/actualizarUsuario';?>","","");

                </script>

            <?php require_once(RUTA_APP . '/views/usuarios/eliminarUsuario.php'); ?>
