<div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="eliminar-cuenta">
  <div class="relative w-auto my-6 mx-auto max-w-3xl">
    ...
    <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
      ...
      <form method="POST" id="formEliminarCuenta" action="<?php echo RUTA_URL; ?>/CuentasBancarias/eliminarCuentasBancarias">    
        <!--body-->
...
<div class="hidden opacity-25 fixed inset-0 z-40 bg-black" id="eliminar-cuenta-backdrop"></div>