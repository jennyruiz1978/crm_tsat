          ...
          <!-- ****** ALERTAS DE ERROR ****** -->
            ...
            <div class="py-4">
                    <div class="inline-flex">
                        <h2 class="text-2xl font-semibold leading-tight flex-1 mr-2">Modalidades</h2>
                    ...
                    <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                        <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                            <div id="destinomodalidadesajax"></div>
                        </div>
                    </div>        
...
<script  type="module">
  ...
  arrancar("tablamodalidades","Modalidades/crearTablaModalidades", "destinomodalidadesajax", "Nº", "DESC", 0, "buscador","Modalidades/totalRegistrosModalidades", [20, 30, 40, 50],"min-w-full leading-normal","paginador",["editar","eliminar"],"<?php echo RUTA_URL.'/Modalidades/editarTecnico';?>","");

</script>

<?php require_once(RUTA_APP . '/views/modalidades/crearNueva.php'); ?>
<?php require_once(RUTA_APP . '/views/modalidades/editarModalidad.php'); ?>
<?php require_once(RUTA_APP . '/views/modalidades/eliminarModalidad.php'); ?>
