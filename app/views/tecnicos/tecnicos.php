    ...
    <div class="container mx-auto px-1 xl:px-2">
            ...
            <div class="py-4">
                    ...
                    <div class="inline-flex">
                        <h2 class="text-2xl font-semibold leading-tight flex-1 mr-2">Técnicos</h2>
                        <a href="<?php echo RUTA_URL;  ?>/Tecnicos/crearTecnico" id="nuevoTecnico" class="rounded-full h-10 w-10 flex items-center justify-center bg-violeta-oscuro text-white flex-1"><i class="fas fa-user-plus"></i></a>
                    </div>                                                     
                    ...
                    <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                        <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                            <div id="destinotecnicosajax"></div>
                        </div>
                    </div>        
...
<script  type="module">
  ...
  arrancar("tablatecnicos","Tecnicos/crearTablaTecnicos", "destinotecnicosajax", "Nº", "DESC", 0, "buscador","Tecnicos/totalRegistrosTecnicos", [20, 30, 40, 50],"min-w-full leading-normal","paginador",["verEditar","eliminar"],"<?php echo RUTA_URL.'/Tecnicos/editarTecnico';?>","");

</script>

<?php require_once(RUTA_APP . '/views/tecnicos/eliminarTecnico.php'); ?>
