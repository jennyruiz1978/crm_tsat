  ...
  <div class="relative w-auto my-6 mx-auto max-w-3xl">
    ...
    <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
      ...
      <div class="relative p-2 flex-auto">      
        ...
        <span id="msgValidaFormBolsa" class="font-bold font-bold text-pink-600"></span>
      ...
      <div class="flex items-center justify-end p-2 border-t border-solid border-blueGray-200 rounded-b">
        ...
        <button id="crearBolsaHoras" class="w-auto bg-violeta-oscuro hover:bg-blue-700 rounded-lg shadow-xl font-medium text-xs md:text-sm text-white px-4 py-1">Crear</button>
