    ...
    <div class="container mx-auto px-1 xl:px-2">
            ...
            <div class="py-1">                    
                    ...
                    <div class="inline-flex">
                        ...
                        <a href="#" id="nuevoCliente" class="rounded-full h-10 w-10 flex items-center justify-center bg-violeta-oscuro text-white flex-1"><i class="fas fa-user-plus"></i></a>
                    </div>               
                    ...
                    <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                        <div class="inline-block min-w-full shadow rounded-lg overflow-hidden" id="contenedorDestino">
                            ...
                            arrancar("tablaclientes","Clientes/crearTabla", "destinoclientesajax", "nombre", "ASC", 0, "buscador","Clientes/totalRegistros", [10, 20, 30],"min-w-full leading-normal","paginador",["editar","eliminar"],"","");
