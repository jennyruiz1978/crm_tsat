    ...
    <main class="w-full flex-grow p-6">        
        ...
        <div class="flex items-center justify-center  mt-8">
            <div class="grid bg-white rounded-lg shadow-xl w-11/12">
                <div class="mt-6 ml-6">
                    <h2 class="text-2xl font-semibold leading-tight flex-1 mr-2">Editar artículo</h2>    
                ...
                <form id="formEditarProducto" >
                    <input type="hidden" name="id" id="id" value="<?php echo $datos['producto']->id;?>">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 xl:grid-cols-6 gap-5 md:gap-8 mt-5 mx-7">
                        ...
                        <div class="grid grid-cols-1">
                            ...
                            <input class="py-2 px-3 rounded-lg border border-gray-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" type="text" value="<?php echo $datos['producto']->numero;?>" disabled/>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:col-span-3">
                            ...
                            <input name="nombre" class="py-2 px-3 rounded-lg border border-gray-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" type="text" value="<?php echo $datos['producto']->nombre;?>" required/>
                        </div>
                        <div class="grid grid-cols-1" style="display: none;">
                            ...
                            <input name="unidad" class="py-2 px-3 rounded-lg border border-gray-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" type="text" placeholder="Unidad" value="<?php echo $datos['producto']->unidad;?>"/>
                        </div>
                        <div class="grid grid-cols-1">
                            <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Stock</label>
                            <input name="stock" class="py-2 px-3 rounded-lg border border-gray-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" type="number" placeholder="Stock" value="<?php echo $datos['producto']->stock;?>"/>
                        </div>
                            ...
                            <select name="iva" class="py-2 px-3 rounded-lg border border-gray-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent">
                                ...
                                <?php                                                            
                                    if(isset($datos['tiposiva']) && count($datos['tiposiva']) > 0){
                                        ...
                                        $tipos_iva = $datos['tiposiva'];
                                        foreach ($tipos_iva as $ivatipo) {
                                            echo'<option value="'.$ivatipo->tipoiva.'" '.(($ivatipo->tipoiva==$datos['producto']->iva)? 'selected':'' ).'>'.$ivatipo->tipoiva.'%</option>';
                                        }
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-5 md:gap-8 mt-5 mx-7">
                            ...
                            <select name="estado" id="estado" class="py-2 px-3 rounded-lg border border-gray-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent">
                                <?php
                                    ...
                                    foreach ($estados as $e) {
                                        echo'<option value="'.$e.'" '.(($e==$datos['producto']->estado)? 'selected':'' ).'>'.$e.'</option>';
                                    }
                        ...
                        <div class="grid grid-cols-1">
                            ...
                            <input name="marca" class="py-2 px-3 rounded-lg border border-gray-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" type="text" placeholder="Marca" value="<?php echo $datos['producto']->marca;?>"/>
                        </div>
                    
                        <div class="grid grid-cols-1">
                            <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Fecha de creación</label>
                            <input name="fecha" type="date" class="py-2 px-3 rounded-lg border border-gray-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" value="<?php echo $datos['producto']->fecha;?>"  disabled/>                      
                        </div>
                        <div class="grid grid-cols-1">
                            <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Última modificación</label>
                            <input name="ultimamodificaicon" id="ultimamodificaicon" class="py-2 px-3 rounded-lg border border-gray-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" value="<?php echo (isset($datos['producto']->modificacion)? date('d-m-Y H:i:s',strtotime($datos['producto']->modificacion)):'' );?>" type="datetime" disabled/>                      
                        </div>                    
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">                            
                        <div class="grid grid-cols-1">
                            ...
                            <textarea name="observaciones" id="observaciones"  class="w-full py-1 px-2 rounded-lg border-2 border-coolGray-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent"><?php echo $datos['producto']->observaciones;?></textarea>
                        </div>
                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-1 gap-2 md:gap-4 m-2">
                                <div class="grid grid-cols-1">
                                    <table id="tablaProveedoresPrecios">
                                        ...
                                        <tbody>
                                            <?php echo $datos['proveedores_precios_html'];?>
                                        </tbody>
                ...
                <div class='flex items-center justify-center  md:gap-8 gap-4 pt-5 pb-5 border-t border-gray-300 mt-6'>
                    ...
                    <button id="guardarProducto" class='w-auto bg-violeta-oscuro hover:bg-blue-700 rounded-lg shadow-xl font-medium text-white px-4 py-2'>Guardar</button>
                </div>
