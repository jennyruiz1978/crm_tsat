        ...
        <main class="w-full flex-grow p-6">
            ...
            <div class="container mx-auto px-1 xl:px-2">
                ...
                <script  type="module">
                    ...
                    arrancar("tablaproductos","Productos/crearTablaProductos", "destinoproductosajax", "pro.numero", "ASC", 0, "buscador","Productos/totalRegistrosProductos", [10, 20, 30],"min-w-full leading-normal","paginador",[],"","","");
