...
<div class="w-full overflow-x-hidden border-t flex flex-col">
    <main class="w-full flex-grow p-4 md:p-6">
        <h2 class="text-2xl font-semibold leading-tight flex-1 mr-2 mb-4">Mi Historial</h2>

        <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
            <form method="GET" action="<?php echo RUTA_URL; ?>/ControlHorario/miHistorial" class="flex flex-wrap gap-3 items-end">
                <div>
                ...
                <a href="<?php echo RUTA_URL; ?>/ControlHorario/miHistorial?mes=<?php echo date('m'); ?>&anio=<?php echo date('Y'); ?>" class="bg-gray-500 text-white px-4 py-2 rounded text-sm hover:bg-gray-600">
                    Mes actual
                </a>
            </form>
        </div>
                        ...
                        <tbody>
                            <?php foreach ($datos['jornadas'] as $jornada): ?>
                                <tr class="border-b border-gray-200 hover:bg-gray-50 text-sm">
                                    ...
                                    <td class="px-4 py-3">
                                        <a href="<?php echo RUTA_URL; ?>/ControlHorario/detalleJornada/<?php echo $jornada->id; ?>" class="text-blue-600 hover:text-blue-800 text-xs">
