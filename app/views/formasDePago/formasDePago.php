          ...
          <!-- ****** ALERTAS DE ERROR ****** -->
            ...
            <div class="py-4">
                    <div class="inline-flex">
                        <h2 class="text-2xl font-semibold leading-tight flex-1 mr-2">Formas de pago</h2>
                        <a id="nuevaFormaDePago" class="rounded-full h-10 w-10 flex items-center justify-center bg-violeta-oscuro text-white flex-1" style="cursor:pointer;"><i class="fas fa-user-plus"></i></a>
                    </div>                                                     
                    ...
                    <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                        <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                            <div id="destinoformasdepagoajax"></div>
                        </div>
                    </div>        
...
<script  type="module">
  ...
  arrancar("tablaformasdepago","FormasDePago/crearTablaFormasDePago", "destinoformasdepagoajax", "Nº", "DESC", 0, "buscador","FormasDePago/totalRegistrosFormasDePago", [20, 30, 40, 50],"min-w-full leading-normal","paginador",["editar","eliminar"],"<?php echo RUTA_URL.'/FormasDePago/editarFormaDePago';?>","");

</script>

<?php require_once(RUTA_APP . '/views/formasDePago/crear.php'); ?>
<?php require_once(RUTA_APP . '/views/formasDePago/editar.php'); ?>
<?php require_once(RUTA_APP . '/views/formasDePago/eliminar.php'); ?>
