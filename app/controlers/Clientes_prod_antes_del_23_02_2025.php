...
class Clientes extends Controlador
{
    ...
    {        
        ...
        $optionCuentas = $this->construirOptionsCuentasBancarias();        
        
        $html .='<div class="grid grid-cols-1 lg:grid-cols-2 gap-2 md:gap-4 m-2">
                    <div class="grid grid-cols-1" id="container-select-cta-cli">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Cuentas Bancarias</label>
                        <select id="selectCuenta" name="selectCuenta" multiple>'.$optionCuentas.'</select>
                    </div>
                </div>';
        ...
        $html .='
                        ...
                        <div class="inline-flex m-2">                       
                                ...
                                <a href="#" id="addContacto" title="Agregar contactos" class="rounded-full h-6 w-6 flex items-center justify-center  bg-blue-700 text-white flex-1"><i class="fas fa-plus-circle"></i></a>                        
                        </div>
